...
class StatusWindow(threading.Thread):
    ...
    def run(self):
        ...
        title_label = tk.Label(
            self.window,
            text="WhisperWriter",
            font=("Indie Flower", 12, "bold"),
            bg="#B0C4DE",
        )
        title_label.place(x=125, y=10, anchor="center")
        self.label = tk.Label(
            self.window, text="", font=("Indie Flower", 14), bg="#B0C4DE"
        )
        ...
        self.icon_label = tk.Label(
            self.window, image=self.microphone_photo, bg="#B0C4DE"
        )
        ...
        self.close_button = tk.Button(
            ...
            font=("Arial", 12, "bold"),
            bg="#B0C4DE",
            command=self.handle_close_button,
            bd=0,
